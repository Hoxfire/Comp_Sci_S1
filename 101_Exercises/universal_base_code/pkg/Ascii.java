...
public class Ascii {
	...
	private String checkType(String a){					// Checks if the input String a is valid
		...
		else if(a.equals("Monk") || a.equals("monk")){
			return "Monk";
		}
	...
	public void printArt(){				// Prints out the name and the art number times
		...
		while (i < number){
			if(type.equals("Human")){
				...
				System.out.println(" T$$$P    |  |_| |_                  ");
				System.out.println(" :$$$     |  | | |_                                                                                             ");
				System.out.println(" :$$$                                                       T$$$$$$$b.                                          ");
				System.out.println(" :$$$     .g$$$$$p.   T$$$$b.    T$$$$$bp.                   BUG     Tb      T$b      T$P   .g$P^^T$$  ,gP^^T$$ ");
				//System.out.println("  $$$    d^"     "^b   $$   Tb    $$     Tb    .s^s. :sssp   $$$     :$; T$$P $^b.     $   dP       T  $P     ");
				System.out.println("  :$$   dP         Tb  $$   :$;   $$      Tb  d'   `b $      $$$     :$;  $$  $ `Tp    $  d$           Tbp.   ");
				System.out.println("  :$$  :$:         :$: $$   :$;   $$      :$; T.   .P $^^    $$$    .dP   $$  $   ^b.  $ :$;             T$$p.  ");
				System.out.println("  $$$  :$:         :$: $$...dP    $$      :$;  `^s^' .$.     $$$...dP     $$  $    `Tp $ :$;      T$$       T$b ");
				System.out.println("  $$$   Tb.       ,dP  $$^^^Tb    $$      dP ^^$^^$   $ $^^  $$$^^T$b     $$  $      ^b$  T$       T$ ;      $$;");
				System.out.println("  $$$    Tp._   _,gP   $$   `Tb.  $$    ,dP    $  $...$ $..  $$$   T$b    :$  $       `$   Tb.     :$ T.    ,dP ");
				System.out.println("  $$$;     ^$$$$$^    d$$     `T.d$$$$$P^      $  $^^^$ $__, $$$    T$b  d$$bd$b      d$b    ^TbsssP  'T$bgd$P  ");
